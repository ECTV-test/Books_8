  ...
  function showFatal(err){
    try{
      ...
      document.body.innerHTML =
        '<div style="font-family:ui-monospace,Menlo,Consolas,monospace;padding:16px;color:#fff;">' +
        '<div style="font-size:18px;font-weight:800;margin-bottom:8px;">App crashed</div>' +
        '<pre style="white-space:pre-wrap;word-break:break-word;opacity:.9;">' + 
        msg.replace(/</g,'&lt;') + 
        '</pre>' +
        '<div style="margin-top:10px;opacity:.7;">Copy this error and send it to the developer.</div>' +
        '</div>';
    }catch(e){}
  }
