...
const UI_STR = {
  en: {
    ...
    ui_lang_hint: "Interface language",
    bookmark: "Bookmark",
    speak: "Speak",
    modal_continue: "${t("modal_continue")}",
    modal_start_bookmark: "${t("modal_start_bookmark")}",
    modal_cancel: "Cancel",
  },
  uk: {
    tabs_books: "Книги",
    ...
    ui_lang_hint: "Мова інтерфейсу",
    bookmark: "Закладка",
    speak: "Озвучити",
    modal_continue: "Продовжити з місця",
  ...
  ru: {
    ...
    ui_lang_hint: "Язык интерфейса",
    bookmark: "Закладка",
    speak: "Озвучить",
    modal_continue: "Продолжить с места",
...
function applyUiLang(){
  ...
  try{
    ...
    if(hint) hint.textContent = t("ui_lang_hint");
